...
then
    ...
    then
        ...
        then
            ...
            # libicu versions: libicu75 -> libicu74 -> libicu73 -> libicu72 -> libicu71 -> libicu70 -> libicu67 -> libicu66 -> libicu63 -> libicu60 -> libicu57 -> libicu55 -> libicu52
            apt install -y libicu75 || apt install -y libicu74 || apt install -y libicu73 || apt install -y libicu72 || apt install -y libicu72 || apt install -y libicu71 || apt install -y libicu70 ||apt install -y libicu67 || apt install  -y libicu66 || apt install -y libicu63 || apt install -y libicu60  || apt install -y libicu57 || apt install -y libicu55 || apt install -y libicu52
            if [ $? -ne 0 ]
            then
                echo "'apt' failed with exit code '$?'"
                print_errormessage
